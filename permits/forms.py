...
class PermitRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        'load_length_ft', 'load_length_in', 'load_width_ft', 'load_width_in', 'load_height_ft', 'load_height_in', 'load_weight',
        ...
        'kingpin_to_rear_ft', 'kingpin_to_rear_in',
        ...
        widgets = {
            ...
            'load_length_ft': forms.NumberInput(attrs={'class': 'form-control dim-ft', 'placeholder': 'ft'}),
            'load_length_in': forms.NumberInput(attrs={'class': 'form-control dim-in', 'placeholder': 'in'}),
            'load_width_ft': forms.NumberInput(attrs={'class': 'form-control dim-ft', 'placeholder': 'ft'}),
            'load_width_in': forms.NumberInput(attrs={'class': 'form-control dim-in', 'placeholder': 'in'}),
            'load_height_ft': forms.NumberInput(attrs={'class': 'form-control dim-ft', 'placeholder': 'ft'}),
            'load_height_in': forms.NumberInput(attrs={'class': 'form-control dim-in', 'placeholder': 'in'}),
            ...
            'kingpin_to_rear_ft': forms.NumberInput(attrs={'class': 'form-control dim-ft', 'placeholder': 'ft'}),
            'kingpin_to_rear_in': forms.NumberInput(attrs={'class': 'form-control dim-in', 'placeholder': 'in'}),
